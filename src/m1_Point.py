...
class Point(object):
    ...
    def move_to(self,x,y):
        self.last_location_x = self.x
        self.last_location_y = self.y
        self.x = x
        self.y = y
        self.moves = self.moves + 1
        distance_traveled_x = self.x -self.last_location_x
        distance_traveled_y = (self.y-self.last_location_y)
        self.distance_traveled = (distance_traveled_y**2+ distance_traveled_x**2)**(1/2) + self.distance_traveled
    ...
    def get_distance_from(self, p2):
        ...
        return (dx_squared + dy_squared)**(1/2)


    def get_distance_from_start(self):
        return ((self.y - self.start_y)**2 + (self.x - self.start_x)**2)**(1/2)



    def get_distance_traveled(self):
        #return(self.distance_traveled_y**2 +self.distance_traveled_x**2)**(1/2)
